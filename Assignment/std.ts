...
s1.addCourse(new Course("Physics", 3.0));
...
s2.addCourse(new Course("Chemistry", 3.0));
s2.addCourse(new Course("Data Structure", 3.5));
s2.addCourse(new Course("History", 2.0));

const s3 = new Student("660003", "Charlie");
s3.addCourse(new Course("Calculus", 3.2));
s3.addCourse(new Course("Database", 3.8));
s3.addCourse(new Course("Operating Systems", 3.4));
s3.addCourse(new Course("Networking", 3.0));

const students1: Student[] = [s1, s2, s3];
...
printStudents("Before Add", students1);
...
printStudents("After Add", students1);
